    ...
    <div class="container">
        <div class="media-body text-center text-md-left">
            ...
            <div class="container py-4">
                <div class="row my-3">
                    <form id="details-employee-form" class="contact-form mx-auto border border-dark rounded w-100" 
                        method="post" action="">
                        <input type="hidden" name="Employee_ID" value="<?php echo $tab['Employee_ID']?>">
                        <h6 class="bg-dark border-thick text-success text-left mb-5 p-3 w-100">Employee profile details</h6>
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <a class="text-success text-right col-md-2" href="../views/Employee_DB.php">Modify</a>
                                <a class="text-success col-md-10" href="../views/Employee_DB.php">Go to Employees List</a>
                            </div>
                        </div>
