    ...
    <div class="container">
        <div class="media-body text-center text-md-left">
            ...
            <div class="container py-4">
                <div class="row my-3">
                    <form id="delete-entreprise-form" class="contact-form mx-auto border border-dark rounded w-100" 
                        method="post" action="../controllers/Delete-entreprise_DB.php">
                        <input type="hidden" name="Entreprise_ID" value="<?php echo $tab['Entreprise_ID']?>">
                        <h6 class="bg-dark border-thick text-success text-left mb-5 p-3 w-100">Delete existing company</h6>
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="EntrepriseNote" name="Entreprise_Note" type="text" value="<?php echo $tab['Entreprise_Note']?>"  disabled="disabled">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-offset-2 col-md-10">
                                    <input name="delete-entreprise-submit" type="submit" value="Delete Company" class="form-control text-box single-line btn btn-outline-dark">
                                </div>
                            </div>
                        </div>
                        <div class="mt-5 p-3">
                            <a class="text-success" href="../views/Accueil_DB.php">Go to Company List</a>
                        </div>
