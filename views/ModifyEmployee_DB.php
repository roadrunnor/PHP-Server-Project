            ...
            <div class="container py-4">
                <div class="row my-3">
                    <form id="add-employee-form" class="contact-form mx-auto border border-dark rounded w-100" 
                        method="post" action="../controllers/Modification-employee_DB.php">
                        <input type="hidden" name="Employee_ID" value="<?php echo $tab['Employee_ID']?>">
                        <h6 class="bg-dark border-thick text-success text-left mb-5 p-3 w-100">Modify an existing employee</h6>
                        <div class="form-horizontal">
                            <div class="form-group row mt-4">
                                <label class="control-label text-right text-dark col-md-2" for="FirstName">First Name :</label>
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="FirstName" name="FirstName" type="text" value="<?php echo $tab['Employee_FirstName']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="MiddleName" name="MiddleName" type="text" value="<?php echo $tab['Employee_MiddleName']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="LastName" name="LastName" type="text" value="<?php echo $tab['Employee_LastName']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="EmailAddress" name="EmailAddress" type="text" value="<?php echo $tab['Employee_EmailAddress']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control text-box single-line" id="Titre" name="Title" type="text" value="<?php echo $tab['Employee_Title']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                  <input class="form-control text-box single-line" id="Department" name="Department" type="text" value="<?php echo $tab['Employee_Department']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-offset-2 col-md-10">
                                    <input name="modify-employee-submit" type="submit" value="Save Employee" class="form-control text-box single-line btn btn-outline-dark">
                                </div>
                            </div>
                        </div>
                        <div class="mt-5 p-3">
