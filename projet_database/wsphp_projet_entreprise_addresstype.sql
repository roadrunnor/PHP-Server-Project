...
--
-- Table structure for table `entreprise_addresstype`
--
...
--
-- Dumping data for table `entreprise_addresstype`
--

LOCK TABLES `entreprise_addresstype` WRITE;
/*!40000 ALTER TABLE `entreprise_addresstype` DISABLE KEYS */;
/*!40000 ALTER TABLE `entreprise_addresstype` ENABLE KEYS */;
UNLOCK TABLES;
